...
//                         pfile_in_zip_read_info->byte_before_the_zipfile,SEEK_SET)!=0)
			if (!mpo_seek(pfile_in_zip_read_info->pos_in_zipfile + 
                         pfile_in_zip_read_info->byte_before_the_zipfile, MPO_SEEK_SET,
						 pfile_in_zip_read_info->file))	// MPO
				return UNZ_ERRNO;
//			if (fread(pfile_in_zip_read_info->read_buffer,uReadThis,1,
//                         pfile_in_zip_read_info->file)!=1)
			if (!mpo_read(pfile_in_zip_read_info->read_buffer, uReadThis, NULL,
				pfile_in_zip_read_info->file) || pfile_in_zip_read_info->file->eof)	// MPO
				return UNZ_ERRNO;
...
//			  pfile_in_zip_read_info->pos_local_extrafield,SEEK_SET)!=0)
	if (!mpo_seek(pfile_in_zip_read_info->offset_local_extrafield + 
			  pfile_in_zip_read_info->pos_local_extrafield, MPO_SEEK_SET,
			  pfile_in_zip_read_info->file))	// MPO
		return UNZ_ERRNO;
