...
void vp932_process_command()
{
    ...
    case 'F': {
        if (vp932_command_pointer == 7) {
            if (vp932_command[6] == 'I') {
                printline("VP932: Load picture number information register "
                          "(ignored)");
                ...
                printline("VP932: Goto picture number and continue previous "
                          "play mode (ignored)");
            } else if (vp932_command[6] == 'A') {
                printline(
                    "VP932: Load picture number autostop register (ignored)");
            } else if (vp932_command[6] == 'P') {
                printline(
                    "VP932: Goto picture number then still mode (ignored)");
            } else {
            ...
            if (vp932_command[12] == 'S') {
                printline("VP932: Goto picture number xxxxx and play until "
    ...
    case 'J': {
        if (vp932_command[1] == '0') {
            printline(
                "VP932: Remote control disabled for drive control (ignored)");
        } else if (vp932_command[1] == '1') {
            printline(
                "VP932: Remote control enabled for drive control (ignored)");
        } else {
    ...
    case 'Q': {
        if (vp932_command[vp932_command_pointer - 1] == 'R') {
            ...
            printline(
                "VP932: Play chapter/track (sequence) and halt (ignored)");
        } else if (vp932_command[vp932_command_pointer - 1] == 'N') {
            printline("VP932: Goto track number [time code in track] and play "
                      "(ignored)");
            ...
            printline("VP932: Play chapter/track (sequence) then repeat until "
                      "cleared (ignored)");
        } else {
    ...
    case 'S': {
        if (vp932_command[vp932_command_pointer - 1] == 'F') {
            ...
            printline("VP932: Set slow speed value 1/2, 1/4, 1/8, 1/16, 1 "
                      "step/sec, 1 step/3 sec (ignored)");
        } else if (vp932_command[vp932_command_pointer - 1] == 'A') {
            printline(
                "VP932: Sound forced analog (4 channel NTSC disc) (ignored)");
        } else if (vp932_command[vp932_command_pointer - 1] == 'N') {
            printline(
                "VP932: Sound normal (digital sound if available) (ignored)");
        } else {
