...
#ifdef SAVE_RCSID
static char rcsid =
 "@(#) $Id: SDL_dx5video.c 1815 2005-09-24 21:07:13Z matt $";
#endif
				...
				int width, int height, int bpp, Uint32 flags)
{
 ...
 fprintf(stderr, "refresh rate = %d Hz\n", maxRefreshRate);
		...
		// MPO : some Daphne users are having problems because their monitor don't return
		//  plug n play information and are getting set to too high of refresh rates.
		// So this is a temporary solution until a more permanent one can be found.
		maxRefreshRate = 0;
