...
// philips constructor
philips::philips() { need_serial = true; }
...
bool philips::init_player()
{
    ...
    /*
        ...
        send_tx_string(",1");
        // this command is supposed to start the disc playing and pause on frame
       one, sending
...
// WARNING: This command seems to be inaccurate as it does not work correctly
for Super Don
...
Uint16 philips::get_real_current_frame()
{
    ...
    return ((Uint16)atoi(&s[1])); // first character is an F, followed by the
                                  // frame
}
