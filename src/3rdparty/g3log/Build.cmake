...
IF ("${CMAKE_CXX_COMPILER_ID}" MATCHES ".*Clang")
   ...
   SET(CMAKE_CXX_FLAGS "-D_GLIBCXX_USE_NANOSLEEP")
...
ELSEIF("${CMAKE_CXX_COMPILER_ID}" STREQUAL "GNU")
   ...
   IF (APPLE)
       set(CMAKE_CXX_FLAGS "-pthread -D_GLIBCXX_USE_NANOSLEEP")
   ELSEIF (MINGW)
       set(CMAKE_CXX_FLAGS "-pthread -D_GLIBCXX_USE_NANOSLEEP -D_GLIBCXX_USE_SCHED_YIELD")
   ELSE()
       set(PLATFORM_LINK_LIBRIES rt)
       set(CMAKE_CXX_FLAGS "-rdynamic -pthread -D_GLIBCXX_USE_NANOSLEEP -D_GLIBCXX_USE_SCHED_YIELD")
   ENDIF()
ENDIF()
