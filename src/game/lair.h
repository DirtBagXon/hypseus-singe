...
class lair : public game
{
  ...
  protected:
    ...
    Uint64 m_status_strobe_timer; // indicates when the last status strobe
                                  // occurred
    ...
    unsigned char m_misc_val;     // player1/2 buttons, coin insertion, LD-V1000
                                  // strobe (enabled low)

    bool m_uses_pr7820;  // enables emulation of an older PR-7820 player instead
                         // of an LD-V1000
