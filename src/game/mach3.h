...
#define MACH3_SEARCH_PERIOD                                                    \
    60 // # of display frames of simulated video signal loss during disc
       // searches
...
class mach3 : public game
{
  ...
  protected:
    ...
    int m_signal_loss_counter; // to fool the ROM into thinking that the PR-8210
