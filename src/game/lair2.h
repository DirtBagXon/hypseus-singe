...
// (there is no limit to this, but the real hardware probably wasn't expected to
// hold much)
...
class lair2 : public game
{
  ...
  private:
    unsigned char m_u8SerialBuf[DL2_BUF_SIZE]; // buffer of serial data received
                                               // from laserdisc player
