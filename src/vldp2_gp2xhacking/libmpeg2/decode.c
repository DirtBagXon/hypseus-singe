...
#include <mpo_lib.h>	// to override memset and other stdlib stuff
#include <inttypes.h>
...
//	do_error("mpeg2_parse: about to do switch statement");
...
mpeg2dec_t * mpeg2_init (void)
{
	...
	do_error("about to call mpeg2_accel");

	mpeg2_accel (MPEG2_ACCEL_DETECT);

	do_error("about to call mpeg2_malloc");
	...
	do_error("about to call mpo_memset");

	MPO_MEMSET (mpeg2dec, 0, sizeof (mpeg2dec_t));
